...
import static com.example.agenda.MainActivity.main;
...
public class MediaNotificationManager {
    ...
    private static final String CHANNEL_ID = "com.example.agenda.channel";
    ...
    private NotificationCompat.Builder buildNotification(@NonNull PlaybackStateCompat state,
        ...
        builder.setStyle(
                ...
                .setLargeIcon(BitmapFactory.decodeResource(main.getResources(), R.drawable.logo))
